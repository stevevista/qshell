<template>
  <div id="search" :class="{'search-open':!$store.state.showHeader}">
    <div class="weui-search-bar" id="search_bar" :class="{'weui-search-bar_focusing':!$store.state.showHeader}">
      ...
      <a class="weui-search-bar__cancel-btn" id="search_cancel" v-on:click="$store.commit('setShowHeader',true)">取消</a>
    </div>
    <article>
