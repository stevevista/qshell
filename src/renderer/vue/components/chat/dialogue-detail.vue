  ...
  <div class="dialogue-info">
    <header id="wx-header">
      <div class="center">
        ...
        <span v-if="dialogue.type === 'group'">聊天信息({{dialogue.users.length}})</span>
        <span v-else>聊天详情</span>
      </div>
    </header>
    <div class="member">
      <ul class="chat-dialogue-entry-collect">
        <li v-for="item in dialogue.users">
    ...
    <div class="weui-cells" v-if="dialogue.type === 'group'">
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">群聊名称</div>
        <div class="weui-cell__ft">{{dialogue.groupName}}</div>
      </div>
      <div class="weui-cell weui-cell_access">
    ...
    <div class="weui-cells">
      ...
      <div class="weui-cell weui-cell_switch">
        ...
        <div class="weui-cell__ft"><input type="checkbox" class="weui-switch"v-model="dialogue.quiet"></div>
      </div>
      <div class="weui-cell weui-cell_switch" v-if="dialogue.type === 'group'">
    ...
    <span class="weui-btn weui-btn_warn" style="margin-top: 15px;padding: 0 20px; width:90%;" v-if="dialogue.type === 'group'">删除并退出</span>
  </div>
</template>
<script>
export default {
