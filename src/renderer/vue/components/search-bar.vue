<template>
  <div class="weui_search_bar" :class="isFocus?'weui_search_focusing':''">
    <form class="weui_search_outer" @focus="s_focus">
      ...
      <label :for="searchId" class="weui_search_text" @touchend="s_focus" @click="s_focus">
        <i class="weui_icon_search"></i>
        <span>搜索</span>
      </label>
    </form>
    <a href="javascript:" class="weui_search_cancel" @touchend="s_blur" @click="s_blur">取消</a>
  </div>
</template>
