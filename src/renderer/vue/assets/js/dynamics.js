...
(function () {
  var Color; var DecomposedMatrix; var DecomposedMatrix2D; var InterpolableArray; var InterpolableColor; var InterpolableNumber; var InterpolableObject; var InterpolableString; var Matrix; var Matrix2D; var Set; var Vector; var addTimeout; var addUnitsToNumberInterpolables; var animationTick; var animations; var animationsTimeouts; var applyDefaults; var applyFrame; var applyProperties; var baseSVG; var cacheFn; var cancelTimeout; var clone; var createInterpolable; var defaultValueForKey; var degProperties; var dynamics; var getCurrentProperties; var interpolate; var isDocumentVisible; var isSVGElement; var lastTime; var leftDelayForTimeout; var makeArrayFn; var observeVisibilityChange; var parseProperties; var prefixFor; var propertyWithPrefix; var pxProperties; var rAF; var roundf; var runLoopPaused; var runLoopRunning; var runLoopTick; var setRealTimeout; var slow; var slowRatio; var startAnimation; var startRunLoop; var svgProperties; var timeBeforeVisibilityChange; var timeoutLastId; var timeouts; var toDashed; var transformProperties; var transformValueForProperty; var unitForProperty
    ...
    return function (el) {
      ...
      if (el instanceof Array || el instanceof NodeList || el instanceof HTMLCollection) {
        res = (function () {
          ...
          _results = []
          for (i = _i = 0, _ref = el.length; _ref >= 0 ? _i < _ref : _i > _ref; i = _ref >= 0 ? ++_i : --_i) {
  ...
  InterpolableString = (function () {
    ...
    InterpolableString.prototype.interpolate = function (endInterpolable, t) {
      ...
      newParts = []
      for (i = _i = 0, _ref = Math.min(start.length, end.length); _ref >= 0 ? _i < _ref : _i > _ref; i = _ref >= 0 ? ++_i : --_i) {
  ...
  DecomposedMatrix2D = (function () {
    ...
    DecomposedMatrix2D.prototype.interpolate = function (endMatrix, t) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i]
        newProps[k] = []
        for (i = _j = 0, _ref1 = this.props[k].length; _ref1 >= 0 ? _j < _ref1 : _j > _ref1; i = _ref1 >= 0 ? ++_j : --_j) {
  ...
  Vector = (function () {
    ...
    Vector.prototype.combine = function (b, ascl, bscl) {
      ...
      result = []
      for (i = _i = 0, _ref = this.els.length; _ref >= 0 ? _i < _ref : _i > _ref; i = _ref >= 0 ? ++_i : --_i) {
  ...
  DecomposedMatrix = (function () {
    ...
    DecomposedMatrix.prototype.interpolate = function (decomposedB, t, only) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i]
        decomposed[k] = []
        for (i = _j = 0, _ref1 = decomposedA[k].length - 1; _ref1 >= 0 ? _j <= _ref1 : _j >= _ref1; i = _ref1 >= 0 ? ++_j : --_j) {
  ...
  Matrix = (function () {
    ...
    Matrix.prototype.inverse = function () {
      ...
      while (--ni) {
        ...
        M.els[i] = els
        for (j = _i = 0; i >= 0 ? _i < i : _i > i; j = i >= 0 ? ++_i : --_i) {
          els = []
          np = kp
          np += 1
          while (--np) {
